...
<script>
	$(function() {
		...
		// if (location.search) {
			...
			wmks.connect("wss://vdi-vc.unist.ac.kr/ui/webconsole/authd?" +
					"host=10.82.9.162" +
					"&port=902" +
					"&cfgFile=%2Fvmfs%2Fvolumes%2F1bbd075a-1511709c%2Fblackzac-p02%2Fblackzac-p02.vmx" +
					"&thumbprint=AB:DF:55:BB:27:D2:5D:2C:9A:0B:66:25:9C:67:D0:49:41:9A:27:36" +
					"&ticket=521e704c-8bdc-1733-ea17-45d1b8e7d490" +
			        "&vmId=vm-547" +
					"&encoding=UTF-8");
			layout();
			spinner.show();
